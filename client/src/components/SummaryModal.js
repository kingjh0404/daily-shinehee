...
//         <div className="summary-container">
//           {isLoading ? (
//             <div className="loading">요약 중입니다...⏳</div> // ✨ 로딩 표시
//           ) : (
//             <div className="modal-summary">{summary}</div>
//           )}
//         </div>
...
//               복사하기
//             </button>
//             <a href={twitterShareUrl} target="_blank" rel="noopener noreferrer" className="share-btn">
//               트위터 공유
//             </a>
//             {articleUrl && (
//               <a href={articleUrl} target="_blank" rel="noopener noreferrer" className="original-btn">
//                 원문 보기
//               </a>
//             )}
//           </div>
